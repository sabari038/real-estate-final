          ...
          <ul className="service-list">
            <li>
              <div className="service-card">
                ...
                <h3 className="h3 card-title">
                  <a href="#" onClick={() => navigate('/prop')}>Buy a home</a>
                </h3>
                <p className="card-text">
                  Over 1 million+ homes for sale available on the website, we
                  can match you with a house you will want to call home.
                </p>
                <a href="#" className="card-link" onClick={() => navigate('/prop')}>
            ...
            <li>
              <div className="service-card">
                ...
                <h3 className="h3 card-title">
                  <a href="#" onClick={() => navigate('/prop')}>Rent a home</a>
                </h3>
                <p className="card-text">
                  Over 1 million+ homes for sale available on the website, we
                  can match you with a house you will want to call home.
            ...
            <li>
              <div className="service-card">
                ...
                <h3 className="h3 card-title">
                  <a href="#" onClick={() => navigate('/prop')}>Sell a home</a>
                </h3>
                <p className="card-text">
                  Over 1 million+ homes for sale available on the website, we
                  can match you with a house you will want to call home.
